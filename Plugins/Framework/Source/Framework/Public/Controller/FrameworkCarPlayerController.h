...
#include "FrameworkCarPlayerController.generated.h"
 ...
 */
UCLASS()
class FRAMEWORK_API AFrameworkCarPlayerController : public AGameFeaturedPlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<class APawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<class APawm> VehiclePawn;
