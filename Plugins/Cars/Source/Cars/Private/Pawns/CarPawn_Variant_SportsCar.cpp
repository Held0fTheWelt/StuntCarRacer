...
#include "Pawns/CarPawn_Variant_SportsCar.h"

#include "Wheels/FrontWheel_Variant_SportsCar.h"
#include "Wheels/RearWheel_Variant_SportsCar.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACarPawn_Variant_SportsCar::ACarPawn_Variant_SportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFrontWheel_Variant_SportsCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFrontWheel_Variant_SportsCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URearWheel_Variant_SportsCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URearWheel_Variant_SportsCar::StaticClass();
