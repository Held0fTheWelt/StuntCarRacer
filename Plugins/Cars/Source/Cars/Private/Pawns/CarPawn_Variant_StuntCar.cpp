...
#include "Pawns/CarPawn_Variant_StuntCar.h"


#include "Wheels/FrontWheel_Variant_StuntCar.h"
#include "Wheels/RearWheel_Variant_StuntCar.h"
...
ACarPawn_Variant_StuntCar::ACarPawn_Variant_StuntCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFrontWheel_Variant_StuntCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFrontWheel_Variant_StuntCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URearWheel_Variant_StuntCar::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URearWheel_Variant_StuntCar::StaticClass();
