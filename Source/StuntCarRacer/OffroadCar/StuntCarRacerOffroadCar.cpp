...
#include "StuntCarRacerOffroadCar.h"
#include "StuntCarRacerOffroadWheelFront.h"
#include "StuntCarRacerOffroadWheelRear.h"
...
AStuntCarRacerOffroadCar::AStuntCarRacerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UStuntCarRacerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UStuntCarRacerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UStuntCarRacerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UStuntCarRacerOffroadWheelRear::StaticClass();
