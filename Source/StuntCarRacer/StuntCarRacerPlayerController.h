...
#include "StuntCarRacerPlayerController.generated.h"

class UInputMappingContext;
class AStuntCarRacerPawn;
class UStuntCarRacerUI;
...
class AStuntCarRacerPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AStuntCarRacerPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AStuntCarRacerPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UStuntCarRacerUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UStuntCarRacerUI> VehicleUI;
