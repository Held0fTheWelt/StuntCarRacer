...
#include "StuntCarRacerSportsCar.h"
#include "StuntCarRacerSportsWheelFront.h"
#include "StuntCarRacerSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AStuntCarRacerSportsCar::AStuntCarRacerSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UStuntCarRacerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UStuntCarRacerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UStuntCarRacerSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UStuntCarRacerSportsWheelRear::StaticClass();
